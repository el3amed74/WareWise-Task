...
Route::group(['middleware' => 'auth'], function () {
	...
	Route::get('/hardware/audit-due', function () {
    return view('hardware.audit-due');
})->name('hardwareaudit-due');
    ...
    */
    ...
    Route::resource('checklist-questions', ChecklistQuestionController::class);

    // Add nested routes for checklist questions
